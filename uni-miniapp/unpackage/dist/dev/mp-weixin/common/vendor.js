...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"uni-miniapp","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 30 */
/*!***********************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/pages.json ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 34 */
/*!**************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/utils/auth.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _request = __webpack_require__(/*! ./request */ 38);
var _storage = __webpack_require__(/*! ./storage */ 40);
function loginByWeChatCode(_x) {
  return _loginByWeChatCode.apply(this, arguments);
}
function _loginByWeChatCode() {
  _loginByWeChatCode = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(code) {
    var data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            (0, _storage.setToken)(data.token);
...
function _ensureLogin() {
  _ensureLogin = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
    var _ref,
      _ref$force,
      force,
      loginRes,
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _ref = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, _ref$force = _ref.force, force = _ref$force === void 0 ? false : _ref$force;
            if (!(!force && (0, _storage.getToken)())) {
              _context2.next = 3;
              break;
            }
            return _context2.abrupt("return", (0, _storage.getToken)());
          case 3:
            _context2.next = 5;
            return new Promise(function (resolve, reject) {
              wx.login({
          ...
          case 8:
            _context2.next = 10;
            return loginByWeChatCode(loginRes.code);
          case 10:
...
/* 38 */
/*!*****************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/utils/request.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function normalizeUrl(url) {
  if (!url) return _config.CONFIG.baseURL;
  if (url.startsWith('http://') || url.startsWith('https://')) return url;
  var base = _config.CONFIG.baseURL.replace(/\/$/, '');
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      success: function success(res) {
        ...
        if (body && (0, _typeof2.default)(body) === 'object' && 'code' in body) {
          if (body.code === 1) {
            resolve(body.data);
          } else {
            uni.showToast({
...
/* 39 */
/*!****************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/utils/config.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var CONFIG = {
  // 改成你后端可访问地址：真机/预览建议用局域网 IP，例如 http://192.168.1.10:8080
...
/* 40 */
/*!*****************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/utils/storage.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 50 */
/*!****************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/api/category.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/api/dish.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getDishListByCategory = getDishListByCategory;
var _request = __webpack_require__(/*! ../utils/request */ 38);
function getDishListByCategory(categoryId) {
  return (0, _request.request)({
    url: '/user/dish/list',
    method: 'GET',
    data: {
...
/* 52 */
/*!************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/api/cart.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.subFromCart = subFromCart;
var _request = __webpack_require__(/*! ../utils/request */ 38);
...
function addToCart(_ref) {
  var dishId = _ref.dishId,
    setmealId = _ref.setmealId,
    dishFlavor = _ref.dishFlavor;
  return (0, _request.request)({
...
function subFromCart(_ref2) {
  var dishId = _ref2.dishId,
    setmealId = _ref2.setmealId,
    dishFlavor = _ref2.dishFlavor;
  return (0, _request.request)({
...
/* 71 */
/*!***************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/api/address.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 78 */
/*!*************************************************************!*\
  !*** E:/project/sky-take-out-main/uni-miniapp/api/order.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
